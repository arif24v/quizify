        ...
        {domain &&
          <div className="">
            ...
            <div className="flex flex-row gap-5 items-center justify-center m-5">
              <button className="rounded-2xl bg-amber-300 p-3" onClick={(e) => increment(e, 1)}> I KNEW THE ANSWER </button>
              <button className="rounded-2xl bg-amber-300 p-3"  onClick={handleFlip}> FLIP </button>
              <button className="rounded-2xl bg-amber-300 p-3" onClick={(e) => increment(e, -1)}> I DIDN'T KNOW THE ANSWER </button>
            </div>
          </div>
        }
