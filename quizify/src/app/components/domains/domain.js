...
export default function Domain(props) {
    ...
    return (
        <Link href={'/sets?id=' + props.author}>
            <div className = "rounded-lg border-2 border-black w-full bg-white p-4 m-3 ease-in-out duration-200 hover:cursor-pointer hover:-translate-y-2 hover:shadow-lg hover:shadow-yellow-500" >
